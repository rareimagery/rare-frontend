      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <div className="relative grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <PipelineStep
            ...
            detail="Claude AI builds your hero section, about page, layout, CSS, and theme overrides from your brand profile."
            icon={
      ...
      <section className="border-t border-zinc-800/60 bg-zinc-900/20">
        <div className="mx-auto max-w-5xl px-6 py-20">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            />
            <FeatureCard
              title="Claude Site Generation"
              description="Claude Haiku writes your hero copy, about section, custom CSS, layout config, and brand color system automatically."
              icon={
      ...
      <section className="border-t border-zinc-800/60">
        <div className="mx-auto max-w-3xl px-6 py-20 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-zinc-400">
            Connect your X account. Grok AI analyzes your audience. Claude builds
